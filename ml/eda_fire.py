...
file_path = './data/fire/NFDB_point_20220901.csv'
...
with open('./eda_fire/eda.txt', 'a') as file:
...
plt.savefig('./eda_fire/Histogram of Fire Sizes.png')
plt.show()
...
plt.savefig('./eda_fire/Distribution of Fire Causes.png')
plt.show()
...
plt.savefig('./eda_fire/Total Fire Sizes in HA Over the Years.png')
plt.show()
...
plt.xticks(rotation=45)
plt.savefig('./eda_fire/Fire Causes by Month.png')
plt.show()
...
plt.savefig('./eda_fire/Correlation Heatmap.png')
plt.show()
