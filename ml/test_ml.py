...
if __name__ == "__main__":
    ...
    X_train = train_data.drop(['SIZE_HA', 'CHANCE_OF_FIRE', 'CAUSE_', 'CAUSE_H', 'CAUSE_H-PB', 'CAUSE_L', 'CAUSE_U'], axis=1)
    X_test = test_data.drop(['SIZE_HA', 'CHANCE_OF_FIRE', 'CAUSE_', 'CAUSE_H', 'CAUSE_H-PB', 'CAUSE_L', 'CAUSE_U'], axis=1)
    y_train = train_data[['SIZE_HA', 'CHANCE_OF_FIRE', 'CAUSE_', 'CAUSE_H', 'CAUSE_H-PB', 'CAUSE_L', 'CAUSE_U']]
    y_test = test_data[['SIZE_HA', 'CHANCE_OF_FIRE', 'CAUSE_', 'CAUSE_H', 'CAUSE_H-PB', 'CAUSE_L', 'CAUSE_U']]
    ...
    joblib.dump(best_model, 'best_test_model.pkl')
